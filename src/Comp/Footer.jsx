  ...
  return (
    <DIV>
      ...
      <div style={{display: 'flex', alignItems: "center", justifyContent: "center" }}>
        <div class="card">
          <a class="social-link1" target='_balnk' href='https://github.com/ParmeshwarMurmu' >
          ...
          <a class="social-link2" target='_balnk' href='https://www.linkedin.com/in/parmeshwar-murmu-086a9b184/'>
      ...
      <div>
        <Text className='copyWright' textAlign={"center"} color={"white"} fontSize={"16px"} fontFamily={"Poppins,sans-serif"} fontWeight={"200"}>
        &copy; Copyright 2023 | Parmeshwar Murmu | All rights reserved.
        </Text>
      </div>
    </DIV>
  )
