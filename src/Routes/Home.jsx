...
function Home() {
  ...
  return <DIV class="nav-link home" theme={theme}>
    ...
    <div className='Project' style={{ margin: "auto" }}>
      ...
      <ProjectComp title={"TravelWiz"} image={TravelWiz} github={"https://github.com/ParmeshwarMurmu/imaginary-carpenter-5479"}
      ...
      <ProjectComp title={"Thunder Tech"} image={Thunder} github={"https://github.com/Hasims2001/synonymous-nose-6503"}
