...
// style={{ border: "2px solid yellow", width: "80%", margin: "auto", display: "flex", justifyContent: "space-evenly" }}

function Home() {

  const { theme } = useContext(AppContent)

  return <DIV class="nav-link home" theme={theme}>

    <Box className='imageAndDetailParentDiv' display={{ base: 'flex' }} >
      <div className='imageAndDetail' >
        <Stack spacing={3}>
          ...
          <div className='hiText' style={{ display: "flex", justifyContent: "center" }}>
            ...
            >Hi,</Text>
            <div style={{ width: "13%", }}>
              <img style={{ width: "100%", borderRadius: "40px" }} src="https://c.tenor.com/z2xJqhCpneIAAAAM/wave-hand.gif" alt="" />
            </div>
          </div>
          ...
          <Text
            ...
            fontSize={{ base: 24, sm: 30, md: 30, xl: 30, }}
            fontFamily={"Poppins,sans-serif"}
            fontWeight={"600"}
            style={{ textAlign: "center" }}
          >I am from Jharkhand, Ghatshila</Text>
      ...
      <Box style={{ display: "flex", justifyContent: "center" }}>
        <Center>
          <Image w={{ base: '200px', md: '400px', lg: '400px' }}
            borderRadius='full'
            src={Profile5}
    ...
    <DIV id="about" className="aboutSection" style={{ margin: "auto", marginBottom: "30px" }}>
      <Text
        fontFamily={"Poppins,sans-serif"}
        fontSize={{ base: 30, sm: 30, md: 30, xl: 50, }}
    ...
    <div id="skills" className='skills' style={{ margin: "auto" }}>
      ...
      <div className='softSkillsOthersParentDiv' style={{ display: "flex", justifyContent: "space-around", }}>
        ...
        <div style={{ margin: "10px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <div className='skillsParentDiv'>
              <img className='skillsImages' src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/800px-CSS3_logo.svg.png" alt="" />
    ...
    <div className='Project' style={{ margin: "auto" }}>
      ...
      <ProjectComp title={"TravelWiz"} image={TravelWiz}
        f1={"HTTP Request GET POST PUT PATCH DELETE"}
        f2={"Pagination"}
        f3={"Text Search"}
        f4={"Responsive"}
        f5={" Sorting"}
        ...
        github={"https://github.com/ParmeshwarMurmu/imaginary-carpenter-5479"}
        netlify={"https://calm-seahorse-616fbc.netlify.app/"}
        tech1={"https://www.w3.org/html/logo/badge/html5-badge-h-solo.png"}
        tech2={"https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/800px-CSS3_logo.svg.png"}
        tech3={"https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/800px-JavaScript-logo.png"}
      />

      <ProjectComp title={"Thunder Tech"} image={Thunder}
        f1={"Authentication"}
        f2={"Responsive"}
        f3={" Sorting"}
        f4={"Filtering"}
        description={"Thunder Tech is basically a E-commerce website where user can purchase different electronics devices like Smartphones, Watches and Televisions etc. This includes helping Customers plan their trips by offering information on destinations, activities, and local culture. The website should also aim to provide a seamless user experience and offer the best deals possible."}
        github={"https://github.com/Hasims2001/synonymous-nose-6503"}
        netlify={"https://thundertech.vercel.app/"}
        tech0={"https://www.w3.org/html/logo/badge/html5-badge-h-solo.png"}
        tech1={"data:image/svg+xml;base64,"}
        tech2={"https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/800px-JavaScript-logo.png"}
        tech3={"https://d33wubrfki0l68.cloudfront.net/0834d0215db51e91525a25acf97433051f280f2f/c30f5/img/redux.svg"}
        tech4={"data:image/jpeg;base64,"}
      />


      <ProjectComp title={"Study Verse"} image={studyVerse}
        f1={"Authentication"}
        f2={"Responsive"}
        f3={" Sorting"}
        f4={"Filtering"}
        ...
        tech3={"https://d33wubrfki0l68.cloudfront.net/0834d0215db51e91525a25acf97433051f280f2f/c30f5/img/redux.svg"}
        tech4={"data:image/jpeg;base64,"}
        tech5={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3jOW_7RbdVuI2DSx_hOKQ3YLRp5NAS_5eXc4o6x-ovjbJmbzDpb2CCoXbN9LXwicjsCY&usqp=CAU"}
        tech6={"data:image/png;base64,"}
        tech7={"data:image/png;base64,"}
         />
